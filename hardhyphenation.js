...
Hyphenation = {
	...
	findAndFix : function(hyphenType, selector) {
		if (hyphenType) {
			...
			this.HYPHEN_TYPE_WIDTH = signs[hyphenType.charCodeAt(0) - 32];
		} else {
			return;
		}
		if (selector) {
	...
	checkContent : function() {
		...
		for ( var i = 0; i < len; i++) {
			...
			fixedString = this.breakString(txt, parentWidth - this.HYPHEN_TYPE_WIDTH);
	...
	breakString : function(txt, parentWidth) {
		...
		for ( var i = 0; i < txtLength; i++) {
			...
			// hyphenate 
			// FIXME there is an issue under FF3 where it doesn't hyphenate properly
			if (parentWidth < sum) {
				// if there isn't breaking char on the row we apply hard hyphenation
				if (wbr == 0) {
			...
			if (ch.charCodeAt(0) >= 32 && ch.charCodeAt(0) <= 1103) {
				// increment the sum with the width of the current sign + letter space
...
var signs = new Array(8, 3, 4, 7, 7, 11, 8, 2, 4, 4, 5, 7, 3, 4, 3, 3, 7, 7,
		...
		9, 5, 5, 5, 4, 3, 4, 7,
		7, 8, 8, 7, 8, 8, 11, 7, 9, 9, 7, 8, 9, 9, 9, 9, 8, 9, 7, 8, 9, 7, 9,
		8, 11, 11, 10, 10, 8, 9, 12, 9, 7, 7, 6, 4, 7, 7, 9, 6, 7, 7, 6, 7, 9,
		7, 7, 7, 7, 6, 5, 5, 9, 5, 7, 6, 9, 9, 8, 9, 7, 6, 9);

// the widths of the signs from 32 to 1103 UTF8 when font-size = 12px
var allSigns = new Array(0, 3, 4, 7, 7, 11, 8, 2, 4, 4, 5, 7, 3, 4, 3, 3, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 3, 3, 7, 7, 7, 7, 12, 7, 8, 9, 9, 8, 7, 9, 9, 3, 6, 8, 7, 9, 9, 9, 8, 9, 9, 8, 7, 9, 7, 11, 7, 7, 7, 3, 3, 3, 5, 7, 4, 7, 7, 6, 7, 7, 3, 7, 7, 3, 3, 6, 3, 11, 7, 7, 7, 7, 4, 7, 3, 7, 5, 9, 5, 5, 5, 4, 3, 4, 7, 13, 13, 13, 13, 13, 13, 0, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 3, 3, 7, 7, 7, 7, 3, 7, 4, 9, 4, 7, 7, 4, 9, 7, 5, 7, 4, 4, 4, 7, 6, 3, 4, 4, 4, 7, 10, 10, 10, 7, 7, 7, 7, 7, 7, 7, 12, 9, 8, 8, 8, 8, 3, 3, 3, 3, 9, 9, 9, 9, 9, 9, 9, 7, 9, 9, 9, 9, 9, 7, 8, 8, 7, 7, 7, 7, 7, 7, 11, 6, 7, 7, 7, 7, 3, 3, 3, 3, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 5, 7, 5, 7, 7, 7, 7, 7, 7, 9, 6, 9, 6, 9, 6, 9, 6, 9, 7, 9, 7, 8, 7, 8, 7, 8, 7, 8, 7, 8, 7, 9, 7, 9, 7, 9, 7, 9, 7, 9, 7, 9, 7, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 9, 5, 6, 3, 8, 6, 7, 7, 3, 7, 3, 7, 4, 7, 4, 7, 3, 9, 7, 9, 7, 9, 7, 7, 9, 7, 9, 7, 9, 7, 9, 7, 12, 11, 9, 4, 9, 4, 9, 4, 8, 7, 8, 7, 8, 7, 8, 7, 7, 3, 7, 5, 7, 3, 9, 7, 9, 7, 9, 7, 9, 7, 9, 7, 9, 7,